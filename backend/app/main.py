...
from app.routers import stores, products, prices, location, basket, user
...
# CORS — allow React frontend & Vercel production deployments to call the API
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://flyer-wise.vercel.app",
        "http://localhost:5173",
        "http://localhost:3000",
        "http://127.0.0.1:5173",
    ],
